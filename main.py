...
def link_model(num_nodes, num_features):
    ...
    output = LinkPrediction(100, 1, activation='sigmoid')(nodes)
...
def main():
    ...
    features, edges, attributes, targets = nodes[None, ...], edges[None, None, ...], attributes[None, None, ...], targets[None, None, ...]
