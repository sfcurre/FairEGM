...
def main():
    ...
    final_adj = {'citeseer': "fairadj_20runs/lr-0.005_t2-10",
                 'cora': "fairadj_20runs/lr-0.001_t2-10",
                 'facebook': "fairadj_20runs/lr-0.01_t2-10",
                 'pubmed': "fairadj_20runs/lr-0.005_t2-10"}

    final_walk = {'citeseer': "fairwalk_20runs/dim-16_num-walk-20_walk-len-80_lr-0.01_epoch-1",
                  'cora': "fairwalk_20runs/dim-16_num-walk-20_walk-len-80_lr-0.1_epoch-1",
