...
#python baselines_tune_fairwalk.py --dataset citeseer -d 128 -lr 0.0001 -e 300 -k 5 10 20 40 -f 5
#echo '*********baselines cora*********'
#python baselines_tune_fairwalk.py --dataset cora -d 128 -lr 0.0001 -e 300 -k 5 10 20 40 -f 5
#echo '*********baselines facebook*********'
#python baselines_tune_fairwalk.py --dataset facebook -d 128 -lr 0.0001 -e 300 -k 5 10 20 40 -f 5
#echo '*********baselines german*********'
#python baselines_tune_fairwalk.py --dataset german -d 128 -lr 0.001 -e 500 -k 5 10 20 40 -f 5
#
echo '*********baselines bail*********'
python baselines_tune_fairwalk.py --dataset bail -d 128 -lr 0.01 -e 700 -k 5 10 20 40 -f 5
#echo '*********baselines credit*********'
#python baselines_tune_fairwalk.py --dataset credit -d 128 -lr 0.001 -e 300 -k 5 10 20 40 -f 5
#echo '*********baselines pubmed*********'
#python baselines_tune_fairwalk.py --dataset pubmed -d 128 -lr 0.001 -e 100 -k 5 10 20 40 -f 5